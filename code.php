...
if(isset($_POST['submit'])){
   ...
   $insert = mysqli_query($conn, "INSERT INTO app (name, email, number, date) VALUES('$name','$email','$number','$date')") or die('query failed');
   $SELECT = "SELECT email From us Where email = ? Limit 1";
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    ...
                    <a href="#"> <i class="fas fa-user"></i> by classic creator </a>
                </div>
                <h3>blog title classic creator goes here</h3>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href=""> <i class="fas fa-phone"></i> +91903456789 </a>
            <a href="#"> <i class="fas fa-phone"></i> +91987634567 </a>
            <a href="mailto:classcreator9@gmail.com"> <i class="fas fa-envelope"></i> classcreator9@gmail.com </a>
            <a href="mailto:sujoncse26@gmail.com"> <i class="fas fa-envelope"></i> sujoncse26@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> sylhet, tamilnadu </a>
        </div>
        ...
        <div class="box">
            ...
            <a href="https://www.pinterest.com/pinterest/"> <i class="fab fa-pinterest"></i> pinterest </a>
        </div>

    </div>

    <div class="credit"> created by <span>class creator</span> | all rights reserved </div>
